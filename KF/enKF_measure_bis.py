...
SAVE = "/Odyssey/private/s26calme/code_stage/KF/test/"
...
for k in tqdm.tqdm(range(nb)): # forward in time #nb
    ...
    ens_Ypp = fens_Ypp
    for i in range(Ne):
        ens_Xp[i] = x_a_enkf[0::2,k].T
        ens_Yp[i] = x_a_enkf[1::2,k].T
    # ens_Xp  = x_a_enkf[0::2,:].T#fens_Xp
    # ens_Yp  = x_a_enkf[1::2,:].T#fens_Yp
